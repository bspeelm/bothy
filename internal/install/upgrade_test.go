...
func TestPendingFetchesLeavesOutWhatIsAlreadyThere(t *testing.T) {
	...
	decisions := []tools.Decision{
		{Tool: tools.Tool{Header: slots.Header{Name: "jq"}, Fetch: slots.Fetch{Binary: "jq"}}, Action: tools.UseSystem},
		{Tool: tools.Tool{Header: slots.Header{Name: "zellij"}, Fetch: slots.Fetch{Binary: "zellij"}}, Action: tools.Fetch},
	}
