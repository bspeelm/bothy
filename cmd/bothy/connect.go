...
// unmountArgs releases the mount. Lazy, because a hung connection makes a
// plain unmount fail and leave the directory unusable until a reboot.
func unmountArgs(mount string) []string { return []string{"-u", "-z", mount} }
